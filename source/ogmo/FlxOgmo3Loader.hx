...
class FlxOgmo3Loader
{
	 ...
	 */
	public function loadTilemap(tileGraphic:FlxTilemapGraphicAsset, tileLayer:String = "tiles", ?tilemap:FlxTilemap,
			?autotiling:Null<flixel.tile.FlxBaseTilemap.FlxTilemapAutoTiling>):FlxTilemap
	{
		if (tilemap == null)
		...
		{
			case 0:
				tilemap.loadMapFromArray(layer.data, layer.gridCellsX, layer.gridCellsY, tileGraphic, tileset.tileWidth, tileset.tileHeight, autotiling);
			case 1:
				tilemap.loadMapFrom2DArray(layer.data2D, tileGraphic, tileset.tileWidth, tileset.tileHeight, autotiling);
		}
		return tilemap;
	}
