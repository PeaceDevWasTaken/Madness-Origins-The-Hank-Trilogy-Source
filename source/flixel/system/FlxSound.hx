...
class FlxSound extends FlxBasic
{
	 ...
	 */
	@:allow(flixel.system.frontEnds.SoundFrontEnd.load) @:allow(edited.SoundFrontEnd.load)
	var _sound:Sound;
	...
	#if FLX_SOUND_SYSTEM
	@:allow(flixel.system.frontEnds.SoundFrontEnd) @:allow(edited.SoundFrontEnd)
